...
.  _Integration tests_ checking the integration of multiple code units (which are assumed to be working). +
e.g. `cs.f10.t1.nursetraverse.StorageManagerTest`
.  Hybrids of unit and integration tests checking multiple code units as well as how they are connected together. +
